...
function Page2(){
    ...
    return (
        <div id="section">
            <h1 className="text-gray-500 text-center p-10 text-xl font-[other]">©  anzo.studio 2024 | designed and developed</h1>

            <div className="rotate">
                <h1 className=" text-black text-[40vw] text-center font-[anzo] leading-[34vw]">IMPACTFUL</h1>
            </div>
            <div className="rotate">
                <h1 className=" text-black text-[40vw] text-center font-[anzo] leading-[34vw]">DESIGN</h1>
            </div>
            <div className="rotate">
                <h1 className=" text-black text-[40vw] text-center font-[anzo] leading-[34vw]">IS THE </h1>
            </div>
            <div className="rotate">
                <h1 className=" text-black text-[40vw] text-center font-[anzo] leading-[34vw]">DESIGN</h1>
            </div>
            <div className="rotate">
                <h1 className=" text-black text-[40vw] text-center font-[anzo] leading-[34vw]">THAT</h1>
            </div>
            <div className="rotate">
                <h1 className=" text-black text-[40vw] text-center font-[anzo] leading-[34vw]">WORKS</h1>
            </div>

            <div data-testid="svgRoot-comp-lmyox36t2" className="AKxYR5 comp-lmyox36t2 flex justify-center items-center scale-50 ">
            ...
            <div className="bg-black my-10 w-1/3 h-0.5 mx-auto"></div>          
